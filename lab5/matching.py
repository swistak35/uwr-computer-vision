...
from colors import getRandomColor, COLORS
...
class FeatureMatching:
    ...
    def featureForDrawing(self, draw, x, y, scale, octave, angle, offset):
    ...
    def drawMatch(self, draw, m, offset):
        ...
        (rx1, ry1, radius1, angle1) = self.featureForDrawing(draw, x1, y1, scale1, octave1, currentAngle1, 0)
        (rx2, ry2, radius2, angle2) = self.featureForDrawing(draw, x2, y2, scale2, octave2, currentAngle2, offset)
        color = getRandomColor()
        self.drawSmallCircle(draw, rx1, ry1, width = radius1, outlineColor = color)
        self.drawSmallCircle(draw, rx2, ry2, width = radius2, outlineColor = color)
    ...
    def drawMatches(self, imageFilename1, imageFilename2, matches):
    ...
    def matchImages(self, imageFilename1, imageFilename2, verificationFile):
        ...
        self.drawMatches(imageFilename1, imageFilename2, matches)
...
def run():
    ...
    for fileset in filesets:
        ...
        fm = FeatureMatching()
        fm.matchImages(fileset[0], fileset[1], fileset[2])
